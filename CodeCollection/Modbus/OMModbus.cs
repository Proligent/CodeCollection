...
namespace CodeCollection
{
    ...
    *********************************************************************/
    ...
    public class OMModbus
    {
        ...
        private OMLib.Communication.Modbus modbus = null;
        ...
        {
            modbus = new OMLib.Communication.Modbus(product);
            OMLib.Communication.Modbus.SerchDllPath("x86", "x64");  // Auto select x86/x64 mdbslib.dll
        }
